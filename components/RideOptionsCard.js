...
import { FlatList, Image, Text, TextComponent, TouchableOpacity, View } from 'react-native';
        ...
        <View style={tw `bg-white flex-grow `}>
            ...
            <FlatList 
                ...
                renderItem={({item : {id, multiplier ,image, title}, item}) => (
                    ...
                    style={tw`flex-row items-center px-10 justify-between ${id === selected?.id && "bg-gray-200"} `}>
                        <Image 
                        style={{
                            height: 100,
                            width: 100,
